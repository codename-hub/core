...
$globalBootstrap = realpath(__DIR__.'/../../../../bootstrap.php');
if(file_exists($globalBootstrap)) {
  require_once $globalBootstrap;
} else {
  die("ERROR: No global bootstrap.php found. You might want to initialize your cross-project autoloader using the root composer.json first." . chr(10) );
}
