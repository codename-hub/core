...
use codename\core\bucket\bucketInterface;
...
{
    /**
     * The given config cannot be validated against structure_config_bucket_local.
     * See the validator for more info
     * @var string
     */
     ...
     * @var string
     */
    public const BUCKET_EXCEPTION_BAD_PATH = 'BUCKET_EXCEPTION_BAD_PATH';
    /**
     * Exception thrown if there was a (possibly malicious) path traversal
     * in a given path parameter
     * @var string
     */
    public const BUCKET_EXCEPTION_FORBIDDEN_PATH_TRAVERSAL = 'BUCKET_EXCEPTION_FORBIDDEN_PATH_TRAVERSAL';
    /**
    ...
    {
        $this->errorstack = new errorstack('BUCKET');

        return $this;
    }

    /**
     * Normalizes a file name by its given $filename
     ...
     */
    final public static function factoryFilename(string $filename): filename
    {
        $text = $filename;
    ...
    /**
     * This method normalizes the remote path by trying
     * to prepend the base path if it is not prepended yet.
     * @param string $path
     * @return string
     */
     ...
     * @param array $option
     * @throws exception
     * @see bucketInterface::downloadToClient
     * @todo error handling
     */
    public function downloadToClient(filerelative $remotefile, filename $filename, array $option = []): void
    {
