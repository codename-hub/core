...
class sftp extends \codename\core\validator\structure\config\bucket implements \codename\core\validator\validatorInterface {
    ...
    public function validate($value) : array {
        ...
        if(count($errors = app::getValidator('structure_config_sftp')->reset()->validate($value['sftpserver'] ?? null)) > 0) {
