...
/**
 * format strings for console (cli) output
 * with nice colors
...
class clicolors
{
     ...
     * @var null|clicolors
     */
    protected static ?clicolors $instance = null;
    /**
     * @var array
     */
    ...
    public function getColoredString(string $string, string $foreground_color = null, string $background_color = null): string
    {
        ...
        if (($foreground_color ?? false) && isset($this->foreground_colors[$foreground_color])) {
            $colored_string .= "\033[" . $this->foreground_colors[$foreground_color] . "m";
        }
        // Check if given background color found
        if (($background_color ?? false) && isset($this->background_colors[$background_color])) {
