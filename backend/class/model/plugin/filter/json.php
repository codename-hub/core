 ...
 * @since 2016-02-04
 */
class json extends filter implements filterInterface, executableFilterInterface
{
    /**
     * {@inheritDoc}
     */
    public function matches(array $data): bool
    {
        ...
        if (($this->operator == '=') || ($this->operator == '!=')) {
            ...
            } elseif (!array_key_exists($fieldName, $data) || $data[$fieldName] !== $this->value) {
                return ($this->operator == '!=');
            } else {
                return ($this->operator == '=');
            }
          ...
          || ($this->operator == '<')) {
            ...
            if (strlen($dataValue) === 0 || strlen($this->value) === 0) {
                ...
                $strposFunc = function (string $haystack, string $needle, int $offset = 0) use ($operator) {
                    return $operator == 'LIKE' ? stripos($haystack, $needle, $offset) : strpos($haystack, $needle, $offset);
                };
